...
/*
$c_name = isset($_POST["c_name"])?$_POST["c_name"]:(isset($_SESSION["C_NAME"])?$_SESSION["C_NAME"]:"");
$c_email = isset($_POST["c_email"])?$_POST["c_email"]:(isset($_SESSION["C_EMAIL"])?$_SESSION["C_EMAIL"]:"");
$c_prov = isset($_POST["c_prov"])?$_POST["c_prov"]:(isset($_SESSION["C_PROV"])?$_SESSION["C_PROV"]:"");
...
$c_gender = isset($_POST["c_gender"])?$_POST["c_gender"]:(isset($_SESSION["C_GENDER"])?$_SESSION["C_GENDER"]:"");
$c_age_from = isset($_POST["c_age_from"])?$_POST["c_age_from"]:(isset($_SESSION["C_AGE_FROM"])?$_SESSION["C_AGE_FROM"]:"");
$c_age_to = isset($_POST["c_age_to"])?$_POST["c_age_to"]:(isset($_SESSION["C_AGE_TO"])?$_SESSION["C_AGE_TO"]:"");
$c_serving_license = isset($_POST["c_serving_license"])?$_POST["c_serving_license"]:(isset($_SESSION["C_SERVING_LICENSE"])?$_SESSION["C_SERVING_LICENSE"]:"");
$c_food_handling = isset($_POST["c_food_handling"])?$_POST["c_food_handling"]:(isset($_SESSION["C_FOOD_HANDLING"])?$_SESSION["C_FOOD_HANDLING"]:"");
$c_own_vehicle = isset($_POST["c_own_vehicle"])?$_POST["c_own_vehicle"]:(isset($_SESSION["C_OWN_VEHICLE"])?$_SESSION["C_OWN_VEHICLE"]:"");
$c_drivers_license = isset($_POST["c_drivers_license"])?$_POST["c_drivers_license"]:(isset($_SESSION["C_DRIVERS_LICENSE"])?$_SESSION["C_DRIVERS_LICENSE"]:"");
$c_languages = isset($_POST["c_languages"])?$_POST["c_languages"]:(isset($_SESSION["C_LANGUAGES"])?$_SESSION["C_LANGUAGES"]:"");
$c_languages_other = isset($_POST["c_languages_other"])?$_POST["c_languages_other"]:(isset($_SESSION["C_LANGUAGES_OTHER"])?$_SESSION["C_LANGUAGES_OTHER"]:"");
$c_height_feet = isset($_POST["c_height_feet"])?$_POST["c_height_feet"]:(isset($_SESSION["C_HEIGHT_FEET"])?$_SESSION["C_HEIGHT_FEET"]:"");
$c_height_inches = isset($_POST["c_height_inches"])?$_POST["c_height_inches"]:(isset($_SESSION["C_HEIGHT_INCHES"])?$_SESSION["C_HEIGHT_INCHES"]:"");
$c_hair_colour = isset($_POST["c_hair_colour"])?$_POST["c_hair_colour"]:(isset($_SESSION["C_HAIR_COLOUR"])?$_SESSION["C_HAIR_COLOUR"]:"");
$c_uniform_size = isset($_POST["c_uniform_size"])?$_POST["c_uniform_size"]:(isset($_SESSION["C_UNIFORM_SIZE"])?$_SESSION["C_UNIFORM_SIZE"]:"");
$c_sales_experience = isset($_POST["c_sales_experience"])?$_POST["c_sales_experience"]:(isset($_SESSION["C_SALES_EXPERIENCE"])?$_SESSION["C_SALES_EXPERIENCE"]:"");
$c_work_children = isset($_POST["c_work_children"])?$_POST["c_work_children"]:(isset($_SESSION["C_WORK_CHILDREN"])?$_SESSION["C_WORK_CHILDREN"]:"");
$c_food_beverage = isset($_POST["c_food_beverage"])?$_POST["c_food_beverage"]:(isset($_SESSION["C_FOOD_BEVERAGE"])?$_SESSION["C_FOOD_BEVERAGE"]:"");
$c_technology = isset($_POST["c_technology"])?$_POST["c_technology"]:(isset($_SESSION["C_TECHNOLOGY"])?$_SESSION["C_TECHNOLOGY"]:"");
$c_alcohol_sampling = isset($_POST["c_alcohol_sampling"])?$_POST["c_alcohol_sampling"]:(isset($_SESSION["C_ALCOHOL_SAMPLING"])?$_SESSION["C_ALCOHOL_SAMPLING"]:"");
$c_data_collection = isset($_POST["c_data_collection"])?$_POST["c_data_collection"]:(isset($_SESSION["C_DATA_COLLECTION"])?$_SESSION["C_DATA_COLLECTION"]:"");
$c_merchandising = isset($_POST["c_merchandising"])?$_POST["c_merchandising"]:(isset($_SESSION["C_MERCHANDISING"])?$_SESSION["C_MERCHANDISING"]:"");
$c_acting = isset($_POST["c_acting"])?$_POST["c_acting"]:(isset($_SESSION["C_ACTING"])?$_SESSION["C_ACTING"]:"");
$c_modeling = isset($_POST["c_modeling"])?$_POST["c_modeling"]:(isset($_SESSION["C_MODELING"])?$_SESSION["C_MODELING"]:"");
$c_team_lead = isset($_POST["c_team_lead"])?$_POST["c_team_lead"]:(isset($_SESSION["C_TEAM_LEAD"])?$_SESSION["C_TEAM_LEAD"]:"");
*/
